...
$out_dir = "$out_base_dir/sre10_test_c5";
...
open(IN_TRIALS, "<", "$db_base/keys/core-core.trialkey.csv") or die "cannot open trials list";
...
open(WAVLIST, "<", "$db_base/trials/core-core.ndx") or die "cannot open wav list";
